  ...
  <div class="scrap-item" @click="$emit('view', post)">
    ...
    <div class="scrap-content">
      <div class="scrap-title">
        ...
        <i v-if="post.isAnonymous" class="bi bi-incognito anonymous-icon" title="익명"></i>
      </div>
...
/* 아이콘 호버 효과 */
.scrap-item:hover .like i {
  animation: heartbeat 1.5s ease-in-out infinite;
}

.scrap-item:hover .comment i {
...
.scrap-item:not(:last-child)::after {
  opacity: 1;
}
</style>
